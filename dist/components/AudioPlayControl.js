...
var AudioPlayControl = function (_a) {
    ...
    switch (playerStatus) {
        case player_1.default.STATUS.PLAY:
            return (React.createElement(PauseIcon, { id: "pauseButton", fontSize: "large", onClick: pauseAudio, className: classnames_1.default(classes.icon, classNames.pauseIcon) }));
        case player_1.default.STATUS.STOP:
            return (React.createElement(ReplayIcon, { id: "replayButton", fontSize: "large", onClick: replayAudio, className: classnames_1.default(classes.icon, classNames.replayIcon) }));
        default:
            return (React.createElement(PlayIcon, { id: "playButton", fontSize: "large", onClick: playAudio, className: classnames_1.default(classes.icon, classNames.playIcon) }));
    }
};
